		...
		<el-form :model="cronTabData" ref="cronTabData" label-width="80px">
			...
			<el-form-item label="定时规则">
				...
				<el-row :gutter="20">
					...
					<el-col :span="10">
						<h5>配置案例：</h5>
						<div style="font-size: 12px;line-height: 16px">5 * * * * :
							<span style="color:#909399">每小时的第5分钟执行一次任务</span>
						</div>
						<div style="font-size: 12px;line-height: 16px">30 9 * * * :
							<span style="color:#909399">每天上午的 9:30 执行一次任务</span>
						</div>
						<div style="font-size: 12px;line-height: 16px">30 9 * 8 * :
							<span style="color:#909399">每月8号上午的9:30执行一次任务</span>
						</div>
						<div style="font-size: 12px;line-height: 16px">30 9 * 5 3 :
							<span style="color:#909399"> 每年的3月5日9:30执行一次任务</span>
						</div>
						<div style="font-size: 12px;line-height: 16px">30 9 0 * * :
							<span style="color:#909399">每星期日的上午9:30执行一次任务</span>
						</div>
					</el-col>
				</el-row>
			</el-form-item>
